 ...
 */
public class SearchResultViewAll extends VBox {
	 ...
	 */
	public SearchResultViewAll(SearchController searchController) {
	...
	private void initSearchResultView() {
		...
		if(searchController.getSearchResultsAll() == null || searchController.getSearchResultsAll().isEmpty()){
		...
		searchResults = FXCollections.observableArrayList(searchController.getSearchResultsAll());
